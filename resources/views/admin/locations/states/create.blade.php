            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ URL::to('locations/states') }}" class="btn btn-flat btn-default">View All</a>
                ...
                <form action="{{ route('admin.states.store') }}" method="post" id="submitForm" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="country_id" class="form-control country_id" id="country_id">
                                        ...
                                        @foreach ($dataSet as $countriesData)
                                            <option value="{{ $countriesData->id }}"
                                                {{ $countriesData->id == old('country_id') ? 'selected' : '' }}>
                                                {{ $countriesData->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="state_name" class="form-control" id="state_name"
                                        value="{{ old('state_name') }}" required maxlength="255" />
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group">
