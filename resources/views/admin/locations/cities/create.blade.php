            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ URL::to('locations/cities') }}" class="btn btn-flat btn-default">View All</a>
                ...
                <form action="{{ route('admin.cities.store') }}" method="post" id="submitForm" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <select name="state_id" class="form-control state_id" id="state_id">
                                        ...
                                        @foreach ($dataSet as $cityData)
                                            <option value="{{ $cityData->id }}"
                                                {{ $cityData->id == old('state_id') ? 'selected' : '' }}>
