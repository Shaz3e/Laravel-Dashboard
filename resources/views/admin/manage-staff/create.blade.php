                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.manage-staff.index') }}">Manage Staff</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.manage-staff.index') }}" class="btn btn-flat btn-sm btn-theme"><i class="fa-regular fa-eye"></i> View
                            All</a>
                    </div>
                </div>
                <form action="{{ route('admin.manage-staff.store') }}" method="post" id="submitForm">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email"
                                        value="{{ old('email') }}" email="true" maxlength="255" required />
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="role_id" class="form-control role_id" id="role_id" required>
                                        ...
                                        @foreach ($rolesDataSet as $rolesData)
                                            <option value="{{ $rolesData->id }}"
                                                {{ $rolesData->id == old('role_id') ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="is_active" id="is_active" class="form-control">
                                        ...
                                        <option value="1" {{ old('is_active') == 1 ? 'selected' : '' }}>Enable
                                        </option>
                                    </select>
                                </div>
                            </div>
