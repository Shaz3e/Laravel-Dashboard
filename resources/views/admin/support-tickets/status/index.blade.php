    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Support Ticket Status List</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">View all ticket status</h3>
                    
                        <div class="card-tools">
                            <a href="{{ route('admin.status.create') }}" class="btn btn-flat btn-sm btn-theme"><i
                    ...
                    <table id="dataList" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Ticket Status Slug</th>
                                <th>Ticket Description Name</th>
                                    ...
                                    <td>
                                        ...
                                        <td>
                                                <a class="btn btn-flat btn-primary"
                                                    href="{{ route('admin.status.edit', $data->id) }}"><i
                                                ...
                                                <form action="{{ route('admin.status.destroy', $data->id) }}"
