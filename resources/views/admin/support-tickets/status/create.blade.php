    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Create New Support Ticket Status</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create new ticket status</h3>
                ...
                <form action="{{ route('admin.status.store') }}" method="post" id="submitForm">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">Create New Ticket Status</button>
                    </div>
            </div>
            <!-- /.card -->
            </form>
